...
export default function AdminCompetitionsTSFPage() {
  const router = useRouter();
  useHeader({ title: "Competitions (TSF)" });
  ...
  function goToCreate() {
    router.push("/admin/competitions-tsf/new");
  }

  function goToEdit(id: Id<"competitions">) {
    router.push(`/admin/competitions-tsf/${id}/edit`);
  }
